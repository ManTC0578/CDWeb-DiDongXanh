...
<link href="<c:url value="/resources/Client/Css/bootstrap.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/Client/Css/font-awesome.min.css" />"
	rel="stylesheet">
...
<link href="<c:url value="/resources/Client/Css/jquery-ui.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/Client/Css/owl.carousel.min.css" />"
	rel="stylesheet">
...
<body>
	...
	<!-- latest -->
	<tiles:insertAttribute name="latest"></tiles:insertAttribute>
	<!-- blog -->
	<tiles:insertAttribute name="blog"></tiles:insertAttribute>
	<!-- footer -->
